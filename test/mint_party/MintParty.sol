...
import "../../src/mint_party/errors/Error.sol";
...
contract MintPartyTest is Test, SetUp {
    ...
    function testAddWhiteList() public {
        ...
        MINT_PARTY.addWhiteList(TRADER_B);

        MINT_PARTY.addWhiteList(TRADER_A);
        address[] memory whitelistAccounts = MINT_PARTY.getWhitelistAccounts();
        assertEq(whitelistAccounts.length, 1);
        assertEq(whitelistAccounts[0], TRADER_A);
        assertEq(MINT_PARTY.getBalance(TRADER_A), 0);
    }
