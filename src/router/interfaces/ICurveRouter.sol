...
interface ICurveRouter {
    ...
    function buy(uint256 amountIn, uint256 fee, address token, uint256 deadline) external payable;
    ...
    function sell(uint256 amountIn, address token, uint256 deadline) external;
