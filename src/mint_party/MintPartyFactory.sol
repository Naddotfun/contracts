...
contract MintPartyFactory is IMintPartyFactory {
    ...
    function create(
        ...
        require(whiteListCount <= maxParticipants, ERR_MINT_PARTY_FACTORY_INVALID_MAXIMUM_WHITELIST);
        require(msg.value == fundingAmount, ERR_MINT_PARTY_INVALID_FUNDING_AMOUNT);
        // 기존 파티가 존재하는지 확인
